...
#      (phase-b-side-shader-{greeter,session}.png).
...
pkgs.testers.runNixOSTest {
  ...
  testScript = ''
    ...
    time.sleep(2)
    visual.assert_matches_golden(machine, "phase-b-side-shader-session")
    ...
    print("visual-phase-b-side-shader: ALL ASSERTIONS PASSED")
  '';
}
