...
#
# Same end-to-end claim as visual-phase-b-enc-image.nix, but the
...
pkgs.testers.runNixOSTest {
  ...
  testScript = ''
    ...
    time.sleep(2)
    visual.assert_matches_golden(machine, "phase-b-enc-image-session")
    ...
    print("visual-phase-b-enc-image: ALL ASSERTIONS PASSED")
  '';
}
