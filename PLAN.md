...
| Witness plane (internal to `halmasuit`) | Done | halmasuit composites the configured `HALMASUIT_WITNESS_IMAGE` PNG (`services.halmasuit.witnessImage`) as its bottom-most internal background plane from frame 0 — no separate client. The Phase-B shader-driven evolution stays deferred. |
