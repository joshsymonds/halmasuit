  ...
  outputs =
    ...
    in
    {
      ...
      checks.x86_64-linux = {
        ...
        # Epic #45 rung-4 isolation: kmscube (no halmasuit) to test the
        # GBM/EGL/KMS→monitor present path under VFIO. RUNNER-ONLY.
        nvidia-kmscube = import ./tests/nvidia-kmscube.nix {
          system = "x86_64-linux";
          inherit nixpkgs;
        };
